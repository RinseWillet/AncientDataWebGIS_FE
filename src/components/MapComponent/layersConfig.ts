...
export const layersConfig: LayerConfig[] = [
  ...
  },
  {
    ...
    name: '1952 NRW',
    group: 'Aerial Imagery',
    groupLabel: 'Aerial Photos (NRW, Germany)',
